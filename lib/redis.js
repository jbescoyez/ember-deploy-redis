...
module.exports = CoreObject.extend({
  ...
  upload: function(value, force) {
    var key            = this.taggingAdapter.createTag();

    return this._upload(value, key, force);
  },
  ...
  _upload: function(value, key, force) {
    return this._uploadIfNotAlreadyInManifest(value, key, force)
  ...
  _uploadIfNotAlreadyInManifest: function(value, key, force) {
    var that = this;

    return new RSVP.Promise(function(resolve, reject) {
      that.client.get(key)
        .then(function(result) {
          force || result === null ? resolve() : reject();
        })
        .then(function() {
